...
public class GameManager
{
    ...
    private void StatusMenu()
    {
        ...
        ConsoleUtility.PrintTextHighlights("Gold : ", player.Hp.ToString());
        Console.WriteLine("");
    ...
    private void StoreMenu()
    {
        ...
        {
            storeInventory[i].PrintItemStatDescription();
        }
        Console.WriteLine("");
    ...
    private void PurchaseMenu(string? prompt = null)
    {
        ...
        for (int i = 0; i < storeInventory.Count; i++)
        {
            storeInventory[i].PrintItemStoreDescription(true, i + 1);
        }
        Console.WriteLine("");
        Console.WriteLine("0.나가기");
        Console.WriteLine("");
